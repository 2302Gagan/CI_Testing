define("userfrmAuthenticationController", {
    resend: false,
    gblTimer: null,
    gblCredInfo: "",
    ...
    btnSignUp_OnClick: function() {
        ...
        if ((this.view.tbxUser.text.toLowerCase() !== "hidglobal" || this.view.tbxPassword.text !== "HID")) {
            ...
            this.view.onboarding.onActivationCodeSuccess = success => {
                this.showLoadingIndicator(false);
                this.navigateToOnboarding(success);
            };
            this.view.onboarding.onActivationCodeFailure = error => {
                this.showLoadingIndicator(false);
    ...
    loginUserIdentity: function(info) {
        ...
        var self = this;
        identitySvc.login(info, response => {
    ...
    approveAuth: function(factor) {
        ...
        if (factor == "second") {
            ...
            this.view.authentication.initiateApproveSuccess = success => {
    ...
    sendOTP: function(authType) {
        ...
        this.view.authentication.sendOTPSuccess = success => {
            this.view.btnConfirmOTP.onClick = this.validateOTP;
            this.view.tbxOTP.onDone = this.validateOTP;
            this.contextSwitch("OTP");
            this.showLoadingIndicator(false);
        };
        this.view.authentication.sendOTPFailure = error => {
            //alert(JSON.stringify(error));
            this.showLoadingIndicator(false);
        };
    },
...
define("frmAuthenticationControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_i8eef6ae50fb470da0cef48b88d5620f: function AS_Form_i8eef6ae50fb470da0cef48b88d5620f(eventobject) {
        var self = this;
        return self.init.call(this);
    }
});
define("frmAuthenticationController", ["userfrmAuthenticationController", "frmAuthenticationControllerActions"], function() {
    var controller = require("userfrmAuthenticationController");
    var controllerActions = ["frmAuthenticationControllerActions"];
