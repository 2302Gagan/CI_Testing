define("com/hid/userManagement/useruserManagementController", [`com/hid/userManagement/UserManagementPresentationController`], function(UserManagementPresentationController) {
    return {
        ...
        editFriendlyName: function(context) {
            ...
            UserManagementPresentationController.updateFriendlyName(rowData.deviceId, newfriendlyName, success => this.editFriendlyNameSuccess(context, success), error => {
        ...
        editFriendlyNameSuccess: function(context, response) {
            let rowData = this.view.segmentDevices.data[context.row];
            rowData.friendlyName = {
                "text": response.UpdateDeviceName[0].friendlyName,
                "enable": false
            };
            rowData.edit = {
                "isVisible": true
        ...
        changeDeviceStatusOnClick: function(context) {
            ...
            UserManagementPresentationController.updateDeviceStatus(rowData.deviceId, newStatus, success => this.onUpdateDeviceStatusSuccess(context, success), this.onUpdateDeviceStatusFailure);
        },
        onUpdateDeviceStatusSuccess: function(context, response) {
            var rowData = this.view.segmentDevices.data[context.row];
            var deviceStatusResponse = response.UpdateDeviceStatus[0];
            rowData.status1 = {
                "isVisible": deviceStatusResponse.active
            };
            rowData.status2 = {
                "isVisible": !deviceStatusResponse.active
            };
        ...
        changePasswordOnClick: function() {
            ...
            this.commonEventHandler(this.showLoading, "");
            UserManagementPresentationController.changeUserPassword(this._username, this.view.tabSelfService.txtOldPassword.text, newPassword, this.onPasswordChangeSuccess, this.onPasswordChangeFailure);
        },
        ...
        onPasswordChangeSuccess: function(response) {
            if (response.ChangePassword[0].status) {
                ...
                this.onPasswordChangeFailure("error");
            }
            this.commonEventHandler(this.dismissLoading, "");
        },
        onPasswordChangeFailure: function(error) {
            ...
            if (strError.includes("Password does not match")) {
                ...
                changePwdError = "Password is not Valid";
            }
        ...
        registerApproveOnClick: function() {
            this.commonEventHandler(this.showLoading, "");
            UserManagementPresentationController.registerApproveDevice(this._username, this.onDeviceRegSuccess, this.onDeviceRegFailure);
        },
        onDeviceRegSuccess: function(response) {
            ...
            this.commonEventHandler(this.dismissLoading, "");
            UserManagementPresentationController.initiateDeviceRegistrationPolling(response.deviceId, this.onPollingSuccess, this.onPollingFailure);
        },
        ...
        getPasswordPolicy: function(callback) {
            UserManagementPresentationController.getPasswordPolicy(response => this.onPasswordPolicySuccess(response, callback), error => this.onPasswordPolicyFailure(callback));
        },
...
define("com/hid/userManagement/userManagementControllerActions", {
    /*
...
define("com/hid/userManagement/userManagementController", ["com/hid/userManagement/useruserManagementController", "com/hid/userManagement/userManagementControllerActions"], function() {
    var controller = require("com/hid/userManagement/useruserManagementController");
    var actions = require("com/hid/userManagement/userManagementControllerActions");
